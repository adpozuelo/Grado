/**
 * FindEventsByName managed bean class.
...
/**
 * Managed Bean FindEventsByName
 */
@ManagedBean(name = "findeventsbyname")
@SessionScoped
public class FindEventsByName implements Serializable {
	...
	public FindEventsByName() throws Exception {
	...
	public String start(String name) throws Exception {
		...
		eventList = (Collection<Event>) eventFacade.findEventsByName(name);
		...
		case 1:
			...
			navigation = "/showFindEventsByNameView.xhtml";
			break;

		default:

			navigation = "/listFindEventsByNameView.xhtml";
			break;
